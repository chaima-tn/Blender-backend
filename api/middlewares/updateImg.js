...
filename: function(req, file, cb) {
        ...
        switch ( req.baseUrl ) {
            ...
            case '/users' : 
                return cb(null, `${req.user._id}.${extension}` );//Image name is the product 'ID.FILE_EXTENSION' .
            ...
            case '/stores' :
                ...
                return cb(null, `${req.user.store}.${extension}` );//Image name is the product 'ID.FILE_EXTENSION' .
                        ...
                        async () => {
                           ...
                           // console.log(res.products);
                            ...
                            if (! result.products.includes(productId) )
                              ...
                              cb(null, `${productId}.${extension}` );//Image name is the product 'ID.FILE_EXTENSION' .
                        }
